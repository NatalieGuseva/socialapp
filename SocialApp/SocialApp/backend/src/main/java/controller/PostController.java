...
import common.EmptyPostException;
...
import dto.TagDto;
import entity.Tag;
//import exeption.EmptyPostException;
...
public class PostController {
    ...
    public ResponseEntity<?> createNewPost(@RequestParam(value = "content", required = false) Optional<String> content,
                                           ...
                                           @RequestParam(name = "postTags", required = false) Optional<String> postTags) throws JsonProcessingException, EmptyPostException {
